...
from sqlalchemy import Column, Integer, String, Text, Date, DateTime, DECIMAL, Boolean, ForeignKey, Enum as SAEnum, JSON
...
class Contract(Base, TimestampMixin, SoftDeleteMixin, AuditMixin):
    ...
    accessory_images_1 = Column(JSON)
    washing_labels = Column(JSON)
    origin_labels = Column(JSON)
    accessory_desc_2 = Column(String(200))
    accessory_size_2 = Column(String(100))
    accessory_qty_2 = Column(String(100))
    accessory_images_2 = Column(JSON)
    accessory_desc_3 = Column(String(200))
    accessory_size_3 = Column(String(100))
    accessory_qty_3 = Column(String(100))
    accessory_images_3 = Column(JSON)
    accessory_desc_4 = Column(String(200))
    accessory_size_4 = Column(String(100))
    accessory_qty_4 = Column(String(100))
    accessory_images_4 = Column(JSON)
